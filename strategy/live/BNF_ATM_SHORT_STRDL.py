...
orders = [{'refId': 10001, 'setno': 1, 'ent_txn_type': "sell", 'rpr_txn_type': "buy",
           'idx': "BANKNIFTY", 'otype': "ce", 'status': "Idle", 'expiry': 'week', 'lot': 1, 'startTime': "09:59:00", 'sl_points': 50},
          {'refId': 10002, 'setno': 2, 'ent_txn_type': "sell", 'rpr_txn_type': "buy",
           'idx': "BANKNIFTY", 'otype': "pe", 'status': "Idle", 'expiry': 'week', 'lot': 1, 'startTime': "09:59:00", 'sl_points': 60}]
...
def execute(orders):
    ...
    while True:
        ...
        if orders['status'] == 'Entered':
            logger.info(f'Placing SL order for {etr_inst["set"]}. {etr_inst["name"]}')
