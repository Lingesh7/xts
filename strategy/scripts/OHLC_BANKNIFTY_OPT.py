...
if __name__ == '__main__':
    ...
    strike_range_filter = expiry_filter[expiry_filter.Description.str.contains('|'.join(strike_range))]
    keyv = dict(zip(strike_range_filter.Description, strike_range_filter.ExchangeInstrumentID))
    skipped = []
