...
d2 = {58346: [1234, 7894,41376],58349: [1237, 7897,41377]}
dd = defaultdict(list)
...
oIDs = {'CE': [20030623, 7894,41376], 'PE': [1237, 10025789,41376]}
pending = [20030623, 10025789, 10025787]
pos_pending = ['41376', '41377']


[i for i in oIDs['CE'] if i in pending]
